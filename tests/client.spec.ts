...
describe("Client Class Object Test", () => {
  ...
  it("Should verify that client4's initial collection is an empty array", () => {
    expect(client4.collection).toBeInstanceOf(Array);
    expect(client4.collection.length).toBe(0);
  });
});