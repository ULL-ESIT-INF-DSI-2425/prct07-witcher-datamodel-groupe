...
describe("Merchant Class Object Test", () => {
  ...
  it("Should verify that merchant4's initial collection is an empty array", () => {
    expect(merchant4.collection).toBeInstanceOf(Array);
    expect(merchant4.collection.length).toBe(0);
  });
});